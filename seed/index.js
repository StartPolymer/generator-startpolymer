...
module.exports = yeoman.generators.Base.extend({
  constructor: function () {
    ...
    this.sourceRoot(path.join(path.dirname(this.resolved), 'templates/seed-element-plus'));
  },
  validate: function () {
  ...
  askFor: function () {
    ...
    this.log(yosay('Out of the box I include Polymer\'s seed-element-plus'));
  ...
  seed: function () {
    ...
    var renameElement = function (file) {
      file = file.toString();
      return file.replace(/seed-element-plus/g, this.elementName);
    }.bind(this);
